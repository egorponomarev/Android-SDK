...
/**
 * This task pulls a tuned MediaPlayer out of the MediaPlayer pool, plays it, then finishes.
 *
 * If no tuned MediaPlayer is available, then cancel this task.
 *
 * This task watches for ACTION_AUDIO_BECOMING_NOISY events and connectivity problems and
 * pauses/resumes playback appropriately.
 *
