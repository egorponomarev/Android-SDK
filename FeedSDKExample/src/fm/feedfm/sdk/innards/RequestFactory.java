...
public class RequestFactory {
	...
	public  HttpGet getPlacement() {
		...
		String full_url = this.session.getSbaseurl() + RequestFactory.PLACEMENT_REQUEST;
	...
	public HttpGet getPlacementID(String placement_id) {
		...
		String full_url = this.session.getSbaseurl() + RequestFactory.PLACEMENT_REQUEST + "/" + placement_id;
	...
	public HttpGet getPlacementIDWithStation(String placement_id) {
		...
		String full_url = this.session.getSbaseurl() + RequestFactory.PLACEMENT_REQUEST + "/" + placement_id + "/station";
