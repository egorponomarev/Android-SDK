...
public class RequestFactory {
	...
	public  HttpGet getPlacement() {
		
		String full_url = this.session.getBaseURL() + RequestFactory.PLACEMENT_REQUEST;
		
		HttpGet result = new HttpGet(full_url);
		result.setHeader(RequestFactory.AUTHORIZATION_HEADER, "Basic " + this.session.getAuthToken());
		return result;
	}
	
	public HttpGet getPlacementID(String placement_id) {
		
		String full_url = this.session.getBaseURL() + RequestFactory.PLACEMENT_REQUEST + "/" + placement_id;
	...
	public HttpGet getPlacementIDWithStation(String placement_id) {
		
		String full_url = this.session.getBaseURL() + RequestFactory.PLACEMENT_REQUEST + "/" + placement_id + "/station";
	...
	public HttpPost createPlayRequest(String placement_id, String station_id, String formats, String max_bitrate, String seconds) throws UnsupportedEncodingException {
		...
		String url = this.session.getBaseURL() + RequestFactory.PLAY_REQUEST;
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public HttpPost createPlayStartRequest(String id) throws UnsupportedEncodingException {
		String url = this.session.getBaseURL() + RequestFactory.PLAY_REQUEST + "/" + id + RequestFactory.PLAY_START;
		
		HttpPost result = this.createBasicPostRequest(url,null, null, null, null, null);
		return result;
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public HttpPost createPlayElapseRequest(String id, String seconds) throws UnsupportedEncodingException {
		
		String url = this.session.getBaseURL() + RequestFactory.PLAY_REQUEST + "/" + id + RequestFactory.PLAY_ELAPSED;
		
		HttpPost result = this.createBasicPostRequest(url,null, null, null, null, seconds);
		return result;
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public HttpPost createSkipRequest(String id) throws UnsupportedEncodingException {
		
		
		
		String url = this.session.getBaseURL() + RequestFactory.PLAY_REQUEST + "/" + id + RequestFactory.PLAY_SKIPPED;
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public HttpPost createPlayInvalidate(String id) throws UnsupportedEncodingException {
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public HttpPost createPlayCompleteRequest(String id) throws UnsupportedEncodingException {
		
		String url = this.session.getBaseURL() + RequestFactory.PLAY_REQUEST + "/" + id + RequestFactory.PLAY_COMPLETE_REQUEST;
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public HttpPost createLikeRequest(String id) throws UnsupportedEncodingException {
		
		String url = this.session.getBaseURL() + RequestFactory.PLAY_REQUEST + "/" + id + RequestFactory.PLAY_LIKE_REQUEST;
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public HttpPost createDislikeRequest(String id) throws UnsupportedEncodingException {
		String url = this.session.getBaseURL() + RequestFactory.PLAY_REQUEST + "/" + id + RequestFactory.PLAY_DISLIKE_REQUEST;
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public HttpPost  createUnlikeRequest(String id) throws UnsupportedEncodingException {
		
		String url = this.session.getBaseURL() + RequestFactory.PLAY_REQUEST + "/" + id + RequestFactory.PLAY_UNLIKE_REQUEST;
